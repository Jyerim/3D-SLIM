...
class TrainDataset(BaseDataset):
    ...
    def __init__(self, ann_list, config, **kwargs):
        ...
        if feat_file in TrainDataset.cached_feats and img_feat_file in TrainDataset.cached_feats:
            cached = TrainDataset.cached_feats[feat_file]
            if len(cached) == 3:
            ...
            TrainDataset.cached_feats[feat_file] = (self.scene_feats, self.scene_masks, self.scene_locs)
    ...
    def __getitem__(self, index):
        ...
        scene_id, scene_feat, scene_img_feat, scene_mask, scene_locs, assigned_ids = self.get_anno(index, self.permute, 'train')
